...
public class EncryptionContext
{
    ...
    */
    ...
    public EncryptionContext(ConfigProvider configProvider)
    {

        _key = Convert.FromBase64String(configProvider.EncryptionKey);
        _iv = Convert.FromBase64String(configProvider.EncryptionIV);
